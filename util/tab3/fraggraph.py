...
def single_fraggraph(pep1: str, verbose: bool = False) -> None:
    ...
    frag_mat_plot = draw_fragment_coverage_matrix_plotly(fg, x="intensity", filename=None)

    st.markdown("**Fragment Coverage Matrix:**")
    st.plotly_chart(frag_mat_plot, use_container_width=False, height=1200, width=800)
