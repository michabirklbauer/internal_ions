...
def single_fraggraph(pep1: str, verbose: bool = False) -> None:
    ...
    graph_vis_header = st.subheader("Visualization of the fragmentation graph", divider = DIV_COLOR)
    ...
    plot2 = st.plotly_chart(frag_mat_plot,
...
def double_fraggraph(pep1: str, pep2: str, verbose: bool = False) -> None:
    ...
    with plot_col1:
        ...
        frag_mat_plot_1 = draw_fragment_coverage_matrix_plotly(fg,
                                                               x = "intensity",
                                                               peptidoform_index = 0)
        st.plotly_chart(frag_mat_plot_1,
                        use_container_width = False,
                        height = 500,
                        width = 500)
    ...
    with plot_col2:
        ...
        frag_mat_plot_2 = draw_fragment_coverage_matrix_plotly(fg,
                                                               x = "intensity",
                                                               peptidoform_index = 1)
        st.plotly_chart(frag_mat_plot_2,
        use_container_width = False,
        height = 500,
        width = 500)
